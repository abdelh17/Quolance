describe('Client Flow', () => {
  ...
  it('Error Create Project Flow', () => {
    ...
    cy.get('[data-test="project-desc-error"]').contains(/Project Description must contain at least 80 chracaters/i);
  ...
  it('Success Edit Project Flow', () => {
    ...
    cy.intercept(
      'GET',
      '/api/client/projects/all?page=0&size=5&sortBy=id&sortDirection=asc',
      {
        statusCode: 200,
        body: {
          content: [
    ...
    cy.intercept(
      ...
      '/api/client/projects/cf5408bf-c564-4323-91cc-6f9a7cc993ff',
      {
        ...
        body: {
          ...
          description: "Updated Project description Updated Project description Updated Project description Updated Project description Updated Project description Updated Project description",
          expirationDate: "2025-11-12",
          visibilityExpirationDate: null,
          category: "WEB_DEVELOPMENT",
          priceRange: "LESS_500",
