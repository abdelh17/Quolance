describe('Flow for Unauthenticated Pages', () => {
    it('Flow For Home Page', () => {
        ...
        cy.get('[data-test="hero-title"]').contains(/We're Changing The Way/i);
    ...
    it('Flow For /how-it-works/find-a-freelancer', () => {
        ...
        cy.get('[data-test="Clearly"]').contains(/Clearly outline your project requirements/i);
    ...
    it('Flow For /how-it-works/find-clients', () => {
        ...
        cy.get('[data-test="Stand"]').contains(/Stand out with personalized proposals/i);
    ...
    it('Successfull Flow For Submitting Email on contact-us page', () => {
        ...
        cy.get('[data-test="contact-us-title"]').contains(/Get/i);
        cy.get('[data-test="contact-us-desc"]').contains(/Have questions/i);
        cy.get('[data-test="contact-us-email-title"]').contains(/Email/i);
        cy.get('[data-test="contact-us-email-value"]').contains(/support@quolance.com/i);
        cy.get('[data-test="contact-us-support-hours"]').contains(/Support Hours/i);
        cy.get('[data-test="contact-us-support-day"]').contains(/Mon-Fri:/i);
        cy.get('[data-test="contact-us-github-title"]').contains(/GitHub/i);
        cy.get('[data-test="contact-us-github-value"]').contains(/github.com/i);
        cy.get('[data-test="contact-us-faq-question"]').contains(/Need Quick Answers?/i);
        cy.get('[data-test="contact-us-faq-browse"]').contains(/Browse our FAQ section/i);


        cy.get('[data-test="contact-us-community-title"]').contains(/Join Our Community/i);
        cy.get('[data-test="contact-us-community-slogan"]').contains(/Quolance is an open-source project/i);
        cy.get('[data-test="contact-us-community-star"]').contains(/Star our repository/i);
        cy.get('[data-test="contact-us-community-notify"]').contains(/Get notified about updates/i);
        cy.get('[data-test="contact-us-community-report"]').contains(/Report issues/i);
        cy.get('[data-test="contact-us-community-help"]').contains(/Help us improve the platform/i);
        cy.get('[data-test="contact-us-community-contribute"]').contains(/Contribute/i);
        cy.get('[data-test="contact-us-community-submit"]').contains(/Submit pull requests/i);
        cy.get('[data-test="contact-us-community-check"]').contains(/Check our FAQ section/i);
