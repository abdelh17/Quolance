      ...
      <div className='relative bg-gray-900'>
        ...
        <div className='relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-20'>
          <div className='pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32'>
            <h2 data-test="hero-title-client" className='text-base/7 font-semibold text-b300'>
              Find Your Next Client
            </h2>
            <p data-test="hero-connect-client" className='mt-2 text-4xl font-semibold tracking-tight text-white sm:text-5xl'>
              Connect with Quality Clients & Projects
            </p>
            <p data-test="hero-desc-client"  className='mt-6 text-base/7 text-gray-300'>
            ...
            >
              <span data-test="browse-projects-btn" className='relative z-10'>Browse Projects</span>
            </Link>
            </div>
          </div>
        </div>
      ...
      <div className='bg-white py-18 sm:py-20'>
        <div className='mx-auto max-w-7xl px-6 lg:px-8'>
          <div className='mx-auto max-w-2xl lg:mx-0'>
            ...
            <p data-test="start-journey-subtitle" className='mt-6 text-lg/8 text-gray-600'>
            ...
            <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
              <figure className="relative isolate pt-6 sm:pt-12">
                ...
                <figcaption className="mt-8 text-base">
                  ...
                  <div data-test="banner1-title"  className="mt-1 text-gray-400">UX Designer & Developer</div>
                </figcaption>
              </figure>
            </div>
          </div>
        ...
        <div className='mx-auto max-w-7xl px-6 py-16 sm:py-20 lg:flex lg:items-center lg:justify-between lg:px-8'>
          ...
          <div className='mt-10 flex items-center gap-x-6 lg:mt-0 lg:shrink-0'>
            <Link
              ...
              className='bg-b300 hover:text-n900 relative mt-8 flex items-center justify-center overflow-hidden rounded-full px-8 py-3 font-semibold text-white duration-700 after:absolute after:inset-0 after:left-0 after:w-0 after:rounded-full after:bg-yellow-400 after:duration-700 hover:after:w-[calc(100%+2px)]'
            >
              <span data-test="banner3-create-btn" className='relative z-10'>Create Free Account</span>
            </Link>
          </div>
        </div>
      </div>
