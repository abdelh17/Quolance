   ...
   <section className='sbp-30 stp-15 container'>
     <div>
       ...
       <div className='mt-8 flex items-start justify-start'>
         <div className='border-b50 flex flex-wrap items-center justify-start gap-3 overflow-hidden rounded-lg border p-1 min-[380px]:rounded-full'>
           <div
             ...
             className='text-sm sm:text-base bg-n30 text-n300 flex cursor-pointer items-center justify-start gap-3 rounded-full px-5 py-3 text-start font-medium'
           >
             <PiSliders />
             <span className=''>Filters</span>
           </div>
           <div className='text-sm sm:text-base  bg-n30 text-n300 flex cursor-pointer rounded-full px-5 py-3 text-start font-medium'>
             <span className=''>Location</span>
           </div>
           <div className='text-sm sm:text-base  bg-n30 text-n300 cursor-pointer rounded-full px-5 py-3 text-start font-medium'>
       ...
       >
         ...
         >
           <span className='text-xs sm:text-base relative z-10 flex items-center gap-2'>
