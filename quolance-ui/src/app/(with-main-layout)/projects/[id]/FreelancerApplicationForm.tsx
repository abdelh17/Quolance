    ...
    <section className='py-8'>
      <div>
        ...
        {!application && (
          <>
            <p
              data-test='application-desc'
              className='text-n300 pb-6 font-medium'
            >
          ...
          <div className='space-y-6'>
            ...
            <div className='border-n30 rounded-lg border bg-white'>
              ...
              <div
                ...
                className='border-n30 border-b px-6 py-4'
              >
              ...
              <div className='space-y-7 px-6 py-6'>
                <div>
                  <h3
                    data-test='application-submitted-title'
                    className='text-n700 mb-2 text-sm font-medium'
                  >
                    Your Application Message
                  </h3>
                  <textarea
                    data-test='application-submitted-message'
                    className='text-n300 w-full resize-none rounded-lg border-gray-200 px-4 py-3 text-base'
