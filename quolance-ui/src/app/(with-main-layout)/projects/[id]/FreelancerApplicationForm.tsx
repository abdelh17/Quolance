...
const motivationalLetterValue = watch('motivationalLetter'); // trigger value changes


useEffect(() => {
 setCharacterCount(motivationalLetterValue?.length || 0);
             ...
             <div>
               ...
               <div className='mt-2 flex justify-between text-sm'>
                 ...
                 <p
                   ...
                   className={`${
                     characterCount > maxCharacters ? 'text-red-500' : 'text-n300'
                   }`}
                 >
