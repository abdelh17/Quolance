      ...
      <div className='relative bg-gray-900'>
        ...
        <div className='relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40'>
          <div className='pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32'>
            <h2 data-test="projects-header-title" className='text-b300 text-base/7 font-semibold'>
              Project Catalog
            </h2>
            <p data-test="projects-header-slogan" className='mt-2 text-3xl font-semibold tracking-tight text-white sm:text-4xl'>
              Find Your Next Project Today
            </p>
            <p  data-test="projects-header-desc" className='mt-6 text-base/7 text-gray-300'>
            ...
            <Link
              ...
              className={`bg-b300 hover:text-n900 relative mt-8 flex items-center justify-center overflow-hidden rounded-full px-8 py-3 font-semibold text-white duration-700 after:absolute after:inset-0 after:left-0 after:w-0 after:rounded-full after:bg-yellow-400 after:duration-700 hover:after:w-[calc(100%+2px)]
                          ${user ? 'hidden' : ''}`}
            >
              <span data-test="projects-header-btn" className='relative z-10'>Sign Up For Free</span>
            </Link>
          </div>
        </div>
      </div>
