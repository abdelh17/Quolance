     ...
     <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-between">
       <div>
         <p className="text-sm text-gray-700">
           Showing
           <span className="font-medium"> {(currentPage - 1) * 4 + 1} </span>
           to
           <span className="font-medium"> {Math.min(currentPage * 4, totalPages * 4)} </span>
           of
           <span className="font-medium"> {totalPages * 4} </span>
           results
         </p>
       </div>
       <div>
