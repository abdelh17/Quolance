        ...
        if (error.response?.status === 422) {
          if (errData?.message === 'Unprocessable entity') {
            setError('password', {
              type: 'manual',
              message:
                'New password must contain one uppercase letter, one lowercase letter, and one digit.',
            });
          }
        }
      })
  ...
  return (
    <div className='grid grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8'>
      ...
      <form
        ...
        className='grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2'
      >
        <div className='col-span-full'>
          ...
          {formState.errors.oldPassword && (
            <small data-test='old-password-error' className='text-red-600'>
        ...
        <div className='col-span-full'>
          ...
          {formState.errors.password && (
            <small data-test='new-password-error' className='text-red-600'>
        ...
        <div className='col-span-full'>
          ...
          {formState.errors.confirmPassword && (
            <small data-test='confirm-password-error' className='text-red-600'>
