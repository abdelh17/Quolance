...
function FreelancerCard({
 ...
 const imageProps = isImageURL(profileImage)
   ...
   : {
     ...
     const [errors, setErrors] = useState({ title: false, comment: false });
     ...
     const handleSubmitReview = async () => {
       const hasTitleError = ratings.title.trim() === '';
       const hasCommentError = ratings.comment.trim() === '';


       if (hasTitleError || hasCommentError) {
         setErrors({ title: hasTitleError, comment: hasCommentError });
         return;
       }
