...
interface AddReviewModalProps {
 ...
 setErrors: React.Dispatch<SetStateAction<{ title: boolean; comment: boolean }>>;
 onSubmit: () => void;
}
       ...
       {step === 1 && (
        ...
        {step === 4 && (
           <div className='py-6'>
             ...
             />
             {errors.title && (
               <p className='text-red-500 text-sm mb-3'>Please enter a title</p>
             )}
             ...
             ></textarea>
             {errors.comment && (
               <p className='text-red-500 text-sm mt-1'>Please enter a review</p>
             )}
           </div>
         )}
