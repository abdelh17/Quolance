...
function FreelancersFilterModal({
 ...
 return (
   <>
     ...
     >
       <div className='mx-3 mb-24 mt-14 max-h-[85vh] max-w-[1175px] overflow-y-auto rounded-2xl bg-white p-8 drop-shadow-2xl'>
         ...
         <div className='border-n30 flex flex-col sm:flex-row w-full items-start sm:items-center justify-start gap-4 border-b py-6'>
           <div className='flex items-center gap-3'>
             ...
             <p className='text-n300 text-xs sm:text-lg'>View Rejected Submissions</p>
           </div>
           ...
           <div className='flex items-center gap-3'>
             ...
             <p className='text-n300 text-xs sm:text-lg'>View Canceled Submissions</p>
           </div>
         </div>


         <div className='border-n30 border-b py-6'>
           <p className='text-sm sm:text-xl font-medium '>Category (select one)</p>
           ...
           <div className='border-n30 text-n300 flex items-center justify-between rounded-xl border px-3 py-2'>
             <p className="text-sm sm:text-base">Choose your Category</p>
             <PiCaretDown />
           </div>
         </div>
         ...
         <div className='border-n30 border-b py-6'>
           <p className='pb-3 text-sm sm:text-xl  font-medium'>Services</p>
           <div className='border-n30 text-n300 flex items-center justify-between rounded-xl border px-3 py-2'>
             <p className="text-sm sm:text-base">Choose your Services</p>
             <PiCaretDown />
           </div>
         </div>
         ...
         <div className='border-n30 border-b py-6'>
           <p className='pb-3 text-sm sm:text-xl font-medium'>Expertise Level</p>
         ...
         <div className='border-n30 flex items-center justify-between gap-6 border-b py-6 max-md:flex-col'>
           <div className='w-full'>
             <p className='pb-3 text-sm sm:text-xl font-medium'>Location</p>
             <div className='border-n30 text-n300 flex items-center justify-between rounded-xl border px-3 py-2'>
               <input
                 type='text'
           ...
           <div className='w-full'>
             <p className='pb-3 text-sm sm:text-xl  font-medium'>Languages</p>
             <div className='border-n30 text-n300 flex items-center justify-between rounded-xl border px-3 py-2'>
               <input
                 type='text'
                 placeholder='Type your Location'
         ...
         <div className='flex items-end justify-end gap-4 pt-6 '>
           <button
             className=' text-xs sm:text-base bg-n30 hover:text-n900 relative flex items-center justify-center overflow-hidden rounded-full px-4 py-2 font-medium duration-700 after:absolute after:inset-0 after:left-0 after:w-0 after:rounded-full after:bg-yellow-400 after:duration-700 hover:after:w-[calc(100%+2px)] lg:px-8 lg:py-3'
