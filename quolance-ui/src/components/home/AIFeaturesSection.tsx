...
const aiFeatures: Array<{
  ...
  },
  {
    ...
    description: "AI automatically reviews and validates client projects, instantly approving quality submissions and ensuring consistency across the platform.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
