...
//
//            // Act
//            List<ProjectDto> results = projectService.getProjectDtosByClientId(testClient.getId());
//
//            // Assert
...
//
//            // Act
//            ProjectDto result = projectService.getProjectDtoById(testProject.getId());
//
//            // Assert
//            assertThat(result).isNotNull();
//            assertThat(result.getId()).isEqualTo(testProject.getId());
...
//
//            // Act
//            List<ProjectDto> results = projectService.getAllProjectDtos();
//
//            // Assert
//            assertThat(results).isNotEmpty()
//                    .hasSize(1)
