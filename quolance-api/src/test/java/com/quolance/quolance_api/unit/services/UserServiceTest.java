...
//        applicationContextProviderMock.when(ApplicationContextProvider::getContext).thenReturn(mockApplicationContext);
//        when(mockApplicationContext.getBean(any(Class.class))).thenReturn(/* Return the needed bean mock */);
//
...
//        void verifyEmail_WhenInvalidCode_ThrowsException() {
//            // Arrange
//            String code = "invalid-code";
//            when(verificationCodeRepository.findByCode(code)).thenReturn(Optional.empty());
//
//            // Act & Assert
//            assertThatThrownBy(() -> userService.verifyEmail(code))
//                    .isInstanceOf(ApiException.class)
